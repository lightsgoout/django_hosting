...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'DjangoHostingService.settings_module'
        db.add_column(u'hosting_djangohostingservice', 'settings_module',
                      self.gf('django.db.models.fields.CharField')(
                          default='settings', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DjangoHostingService.settings_module'
        db.delete_column(u'hosting_djangohostingservice', 'settings_module')
