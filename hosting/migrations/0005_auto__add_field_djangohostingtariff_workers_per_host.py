...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'DjangoHostingTariff.workers_per_host'
        db.add_column(u'hosting_djangohostingtariff', 'workers_per_host',
                      self.gf(
    ...
    def backwards(self, orm):
        # Deleting field 'DjangoHostingTariff.workers_per_host'
        db.delete_column(u'hosting_djangohostingtariff', 'workers_per_host')
