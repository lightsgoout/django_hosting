...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'DjangoHostingService.wsgi_module'
        db.add_column(u'hosting_djangohostingservice', 'wsgi_module',
    ...
    def backwards(self, orm):
        # Deleting field 'DjangoHostingService.wsgi_module'
        db.delete_column(u'hosting_djangohostingservice', 'wsgi_module')
