...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'DjangoHostingService.virtualenv_path'
        db.alter_column(u'hosting_djangohostingservice', 'virtualenv_path',
                        self.gf('django.db.models.fields.CharField')(
                            max_length=255, unique=True, null=True))

        # Changing field 'DjangoHostingService.home_path'
        db.alter_column(u'hosting_djangohostingservice', 'home_path',
                        self.gf('django.db.models.fields.CharField')(
                            max_length=255, unique=True, null=True))
