...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'DjangoHostingService.virtualenv_path'
        db.delete_column(u'hosting_djangohostingservice', 'virtualenv_path')

        # Deleting field 'DjangoHostingService.home_path'
        db.delete_column(u'hosting_djangohostingservice', 'home_path')


    def backwards(self, orm):
        # Adding field 'DjangoHostingService.virtualenv_path'
        db.add_column(u'hosting_djangohostingservice', 'virtualenv_path',
        ...
        # Adding field 'DjangoHostingService.home_path'
        db.add_column(u'hosting_djangohostingservice', 'home_path',
                      self.gf('django.db.models.fields.CharField')(unique=True,
                                                                   max_length=255,
                                                                   null=True,
                                                                   blank=True),
