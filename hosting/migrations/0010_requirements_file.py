...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'DjangoHostingService.requirements_file'
        db.add_column(u'hosting_djangohostingservice', 'requirements_file',
    ...
    def backwards(self, orm):
        # Deleting field 'DjangoHostingService.requirements_file'
        db.delete_column(u'hosting_djangohostingservice', 'requirements_file')
